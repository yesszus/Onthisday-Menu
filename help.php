...
if ($otd_action == "admin_readme")
{
    $otd_text .= "<tr><td class='forumheader3'><b>" . OTD_A54 . "</b></td></tr>";
    $otd_text .= "<tr><td class='forumheader3'>" . OTD_A57 . "</td></tr>";
}
if ($otd_action == "admin_vupdate")
{
    $otd_text .= "<tr><td class='forumheader3'><b>" . OTD_H30 . "</b></td></tr>";
    $otd_text .= "<tr><td class='forumheader3'>" . OTD_H31 . "</td></tr>";
}
$otd_text .= "</table>";
